...
![](images/Pasted%20image%2020231005200755.png)블로그를 간단하게 만들고 알아서 다양한 검색엔진에 노출되는 플랫폼들이 있습니다. 해당 플랫폼들은 당연하게 생각하는 여러 편의 기능들을 제공해줍니다. `SEO` 관련 설정들, 포스팅 에디터 제공, 통계 제공, 최적화 등등의 여러 편의 기능들은 우리가 당연하게 생각하고 사용하고 있습니다.
